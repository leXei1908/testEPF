...
//	ТаблицаТовары = ВладелецФормы.Объект.Товары;
	СтрокаНДС = ТоварыНоменклатураПриИзмененииНаСервере(СтруктураСтроки, СтруктураДействий);
	Возврат СтрокаНДС;
//	ВладелецФормы.Объект.Товары = ТаблицаТовары;
КонецФункции

&НаСервере
Функция ТоварыНоменклатураПриИзмененииНаСервере(СтруктураСтроки, СтруктураДействий)
